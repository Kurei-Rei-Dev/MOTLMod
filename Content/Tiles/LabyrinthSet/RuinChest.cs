...
namespace MOTLMod.Content.Tiles.LabyrinthSet
{
    public class RuinChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<Items.Placeables.Blocks.RuinItemSet.RuinChest>(), 1);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeables.Blocks.RuinItemSet.RuinChest>();
